...
namespace Microsoft.Azure.Relay {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The response header &apos;{0}&apos; was not found..
        /// </summary>
        internal static string net_WebSockets_ResponseHeaderMissing {
            get {
                return ResourceManager.GetString("net_WebSockets_ResponseHeaderMissing", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The response status line value &apos;{0}&apos; is invalid..
        /// </summary>
        internal static string net_WebSockets_ResponseStatusInvalid {
            get {
                return ResourceManager.GetString("net_WebSockets_ResponseStatusInvalid", resourceCulture);
            }
        }
